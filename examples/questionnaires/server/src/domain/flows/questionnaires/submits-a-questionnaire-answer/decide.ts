...
import type { QuestionAnswered, QuestionnaireEditRejected } from './events';

export const decide = (
  command: AnswerQuestion,
  state: State,
): (QuestionAnswered | QuestionnaireEditRejected) | (QuestionAnswered | QuestionnaireEditRejected)[] => {
  switch (command.type) {
    case 'AnswerQuestion': {
      /**
