...
flow('Beautiful Questionnaire App', () => {
  ...
  experience('Create Survey').client(() => {
    specs(() => {
  ...
  experience('Response Analytics').client(() => {
    specs(() => {
  ...
  experience('Manage Templates').client(() => {
    specs(() => {
  ...
  experience('Survey Completion Tracker').client(() => {
    specs(() => {
  ...
  experience('Response Goals Tracker').client(() => {
    specs(() => {
  ...
  experience('Response History').client(() => {
    specs(() => {
