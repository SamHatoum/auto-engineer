import { commandSlice, querySlice, reactSlice, flow, createBuilders, should, given, when, specs, gql, source, data, sink } from '@auto-engineer/flowlang';
...
flow('Seasonal Assistant', () => {
  ...
  commandSlice('enters shopping criteria into assistant')
    ...
    .server(() => {
      data([
        sink().event('ShoppingCriteriaEntered').toStream('shopping-session-{id}'),
      ]);
