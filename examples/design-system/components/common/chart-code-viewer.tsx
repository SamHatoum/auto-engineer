...
import { ChartCopyButton } from '@/components/common/chart-copy-button';
import { Chart } from '@/components/common/chart-display';
  ...
  const content = (
    <div className="flex min-h-0 flex-1 flex-col gap-0">
      ...
      <div className="flex min-w-0 flex-1 flex-col overflow-hidden p-4">
        <figure data-rehype-pretty-code-figure="" className="mt-0 flex h-auto min-w-0 flex-1 flex-col overflow-hidden">
          <figcaption
          ...
          >
            ...
            <div className="ml-auto flex items-center gap-2">
              <ChartCopyButton event="copy_chart_code" name={chart.name} code={chart.files?.[0]?.content ?? ''} />
