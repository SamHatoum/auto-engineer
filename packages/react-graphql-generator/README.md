...
npm install @auto-engineer/react-graphql-generator
```
...
- **@auto-engineer/emmett-generator**: Consumes GraphQL schemas from generated servers
- **@auto-engineer/design-system-importer**: Integrates imported design tokens and components
- **@auto-engineer/frontend-implementation**: Provides scaffolding for AI-powered implementation
