...
const debug = createDebug('react-graphql-generator:generateComponents');
const debugTemplates = createDebug('react-graphql-generator:generateComponents:templates');
const debugOutput = createDebug('react-graphql-generator:generateComponents:output');
